...
<li class="page_item page-item-27"><a href="stu_login.html">Login</a></li>
</ul></div>
			</nav>
		</div>
	</header>
...
<div class="col-md-2"></div>
<div class="col-md-8">
	<form class="form" action="stu_login.php" method="post">
		...
		<br>
			<center>
			<!-- IF LOGIN CORRECT REDIRECT TO student_logged_in/index.html -->
			...
			<div class="col-md-3">
				<a href="stu_reg.html"><input type="button" value="Not a user yet ?" name="no_fac_acc" /> </a>
			</div>
