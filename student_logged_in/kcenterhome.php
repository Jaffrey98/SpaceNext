...
<script type="text/javascript" src="./index_files/wp-embed.min.js.download"></script>
	...
	<img src="index_files/comm.jpg" style="margin-left: 50px" width="1250">
	<p class="title titlec">
	...
	<p class="contentc">
		<strong>Mars Orbiter Mission</strong><br>
	...
	<p class="contentc">
		<strong>Chandrayaan-1</strong><br>
	...
	<img src="index_files/launch_vehicles.png" style="margin-left: 50px" width="1250">
	<br><br><br><br>
	...
	<div class="row">
		...
		<div class="col-md-10" style="margin-left: 40px;">
			<div class="col-md-4">
				<img src="index_files/pslv.png">
			</div>
			<div class="col-md-4">
				<img src="index_files/gslv.png">
			</div>
			<div class="col-md-4">
				<img src="index_files/sounding_rockets.png">
			</div>
		</div>
		<div class="col-md-1"></div>
	</div>
